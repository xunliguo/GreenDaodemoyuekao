...
public class BeanDao extends AbstractDao<Bean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Banshe = new Property(2, String.class, "banshe", false, "BANSHE");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Bean entity) {
        ...
        String banshe = entity.getBanshe();
        if (banshe != null) {
            stmt.bindString(3, banshe);
        }
    }
    ...
    public Bean readEntity(Cursor cursor, int offset) {
        Bean entity = new Bean( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // banshe
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Bean entity, int offset) {
        ...
        entity.setBanshe(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
